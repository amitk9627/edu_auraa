...
import BannerImage from "../../assets/images/Banner.svg?url";
import DropdownArrow from "../../assets/images/dropdownArrow.svg?url";
  ...
  return (
    ...
    >
      <div className="absolute inset-0 flex flex-col items-center justify-center px-4 text-center">
        <h1 className="text-[28px] md:text-[40px] font-bold mb-[16px] md:mb-[20px] leading-[36px] md:leading-[52px] text-white drop-shadow-md">
          Find Your Perfect Coaching Institute Today!
        </h1>
        <p className="text-[20px] md:text-[32px] mb-[32px] md:mb-[40px] leading-[30px] md:leading-[44px] text-white drop-shadow-md">
          Explore top-rated coaching centers tailored to your needs.
        </p>
        <div className="bg-white rounded-[8px] shadow-lg sm:px-[16px] md:px-0 py-[16px] w-full max-w-6xl flex flex-wrap justify-center gap-4">
        ...
        <button className="w-full md:w-auto px-6 py-2 bg-[#0A82C5] text-white text-[16px] font-medium hover:bg-blue-700 cursor-pointer">
          Search
        </button>
      </div>
      </div>
